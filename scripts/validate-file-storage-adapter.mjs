...
const storagePos=index.indexOf('./swir-file-storage.js');
const bridgePos=index.indexOf('./swir-platform-bridge.js');
assert(storagePos>=0&&bridgePos>storagePos,'storage adapter must load before platform bridge');
...
console.log('SWIR File Explorer storage adapter contract OK');
