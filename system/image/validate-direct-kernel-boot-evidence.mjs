...
const requiredTrue = ['directKernelBoot', 'guestNetworkDisabled', 'systemdBooted', 'logindActive', 'networkManagerActive', 'peerAuthorizationSocketActive', 'readinessPassed'];
