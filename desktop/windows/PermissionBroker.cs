...
internal sealed class PermissionBroker
{
    ...
    private static string? RequiredPermission(string surface, string method) => (surface, method) switch
    {
        ...
        ("processes", "info" or "list") => "process.inspect",
        ("processes", "spawn") => "process.spawn",
        ("processes", "kill") => "process.kill",
        ("services", "info" or "list") => "service.inspect",
        ("network", "status" or "adapters") => "network.inspect",
        ("devices", "info" or "list") => "device.inspect",
        ("identity", "info" or "account" or "session") => "identity.inspect",
        ...
        ("packages", "info" or "status") => "packages.inspect",
        ("packages", "installFromCapability" or "rollback") => "packages.manage",
        ("updates", "readiness" or "check" or "preparationStatus") => "updates.inspect",
        ("updates", "applyAndRestart" or "prepare" or "cancelPrepare" or "resetPreparation") => "updates.apply",
        _ => null
    };
