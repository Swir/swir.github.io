/* SWIR OS 1.6 — official package catalog */
window.SWIR_PACKAGE_CATALOG = Object.freeze([
  {
    schema:"swir.app/1.0", id:"code", packageId:"swir.code", name:"SWIR Code", version:"1.0.0", author:"SWIR",
    ...
    permissions:["files.read","files.write","clipboard","downloads"], tags:["code","editor","html","javascript","text"]
  },
  {
    schema:"swir.app/1.0", id:"image", packageId:"swir.image-studio", name:"Image Studio", version:"1.0.0", author:"SWIR",
    ...
    permissions:["files.read","files.write","downloads"], tags:["image","photo","canvas","editor"]
  },
  {
    schema:"swir.app/1.0", id:"archive", packageId:"swir.archive", name:"Archive Manager", version:"1.0.0", author:"SWIR",
    ...
    permissions:["files.read","files.write","downloads"], tags:["zip","archive","files","compress"]
  },
  {
    schema:"swir.app/1.0", id:"pdf", packageId:"swir.pdf-viewer", name:"PDF Viewer", version:"1.0.0", author:"SWIR",
    ...
    permissions:["files.read"], tags:["pdf","documents","viewer"]
  },
  {
    ...
    permissions:["network","storage","identity.basic","notifications"], tags:["chat","social","server","live"]
  }
]);

window.SWIR_PERMISSION_INFO = Object.freeze({
  "files.read":"Read files selected by the user",
